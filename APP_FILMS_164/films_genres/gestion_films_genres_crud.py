        ...
        try:
            with DBconnection() as mc_afficher:
                strsql_genres_films_afficher_data = """SELECT r.id_reservation AS id_reservation,
                                                        ...
                                                        f.temp AS duree_fichier FROM reservation r JOIN personne p ON r.personne_id = p.id_personne JOIN imprimante i ON r.imprimante_id = i.id_imprimante JOIN fichier_utiliser f ON i.fichier = f.id_fichier
"""
                if id_film_sel == 0:
                ...
                if not data_genres_films_afficher and id_film_sel == 0:
                    ...
                    flash(f"Données reservation affichés !!", "success")
...
"""
    ...
    Récupère la liste de tous les imprimante du film sélectionné par le bouton "MODIFIER" de "films_genres_afficher.html"
    
    Dans une liste déroulante particulière (tags-selector-tagselect), on voit :
    1) Tous les imprimante contenus dans la "t_genre".
    2) Les imprimante attribués au film selectionné.
    3) Les imprimante non-attribués au film sélectionné.
...
def edit_genre_film_selected():
    if request.method == "GET":
        try:
            ...
            # 2) Sélection des imprimante "déjà" attribués pour le film.
            # 3) Sélection des imprimante "pas encore" attribués pour le film choisi.
            ...
            # les imprimante qui ne sont pas encore sélectionnés.
            ...
            # Dans le composant "tags-selector-tagselect" on doit connaître
            # les imprimante qui sont déjà sélectionnés.
...
def update_genre_film_selected():
    if request.method == "POST":
        try:
            ...
            # Récupère la liste des imprimante qui ne sont pas associés au film sélectionné.
            ...
            # Récupère la liste des imprimante qui sont associés au film sélectionné.
            ...
            # Récupère ce que l'utilisateur veut modifier comme imprimante dans le composant "tags-selector-tagselect"
            ...
            with DBconnection() as mconn_bd:
                ...
                # Pour le film sélectionné, parcourir la liste des imprimante à EFFACER dans la "t_genre_film".
                # Si la liste est vide, la boucle n'est pas parcourue.
...
"""
    ...
    Récupère la liste de tous les imprimante du film sélectionné par le bouton "MODIFIER" de "films_genres_afficher.html"
    Nécessaire pour afficher tous les "TAGS" des imprimante, ainsi l'utilisateur voit les imprimante à disposition
