...
from APP_FILMS_164.imprimante.gestion_imprimante_wtf_forms import FormWTFAjouterGenres
from APP_FILMS_164.imprimante.gestion_imprimante_wtf_forms import FormWTFDeleteGenre
from APP_FILMS_164.imprimante.gestion_imprimante_wtf_forms import FormWTFUpdateGenre
...
"""
    ...
    Test : ex. cliquer sur le menu "imprimante" puis cliquer sur le bouton "DELETE" d'un "genre"

    Paramètres : sans

    But : Effacer(delete) un genre qui a été sélectionné dans le formulaire "imprimante_afficher.html"

    Remarque :  Dans le champ "nom_genre_delete_wtf" du formulaire "imprimante/imprimante_delete_wtf.html",
